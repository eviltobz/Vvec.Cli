...
using Vvec.Cli.SourceGenerator;

namespace VvecCli.SourceGenerator.Tests.Utils
{
    public static class TestExtensions
    {
        ...
        public static async Task<Project> ApplyCommandRegistrationGenerator(this Project project)
        {
            var newProject = await project.RunSourceGenerator(new CommandRegistrationGenerator());
